  ...
  return (
    <StyledServersContainer>
        <div className="server_buttons_container">
          <button className={server === "vidsrc.in" ? "active" : ""} onClick={() => setSource(showId ? `https://vidsrc.in/embed/tv/${showId}/${selectedSeason}/${selectedEpisode}` : `https://vidsrc.in/embed/movie?tmdb=${movieId}`)}>Server 1</button>
